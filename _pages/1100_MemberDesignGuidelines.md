...
### <a name="av1105"></a> Use a method instead of a property in the following cases (AV1105) ![](/assets/images/3.png)
...
### <a name="av1115"></a> A property, method or local function should do only one thing (AV1115) ![](/assets/images/1.png) ![](/assets/images/A.png)
...
### <a name="av1130"></a> Return an `IEnumerable<T>` or `ICollection<T>` instead of a concrete collection class (AV1130) ![](/assets/images/2.png) ![](/assets/images/A.png)
