...
### <a name="av1000"></a> A class or interface should have a single purpose (AV1000) ![](/codingguidelines/assets/images/1.png) ![](/codingguidelines/assets/images/A.png)
...
### <a name="av1003"></a> An interface should be small and focused (AV1003) ![](/codingguidelines/assets/images/2.png)
...
### <a name="av1004"></a> Use an interface rather than a base class to support multiple implementations (AV1004) ![](/codingguidelines/assets/images/3.png)
...
### <a name="av1005"></a> Use an interface to decouple classes from each other (AV1005) ![](/codingguidelines/assets/images/2.png)
...
### <a name="av1011"></a> It should be possible to treat a derived object as if it were a base class object (AV1011) ![](/codingguidelines/assets/images/2.png)
...
### <a name="av1013"></a> Don't refer to derived classes from the base class (AV1013) ![](/codingguidelines/assets/images/1.png)
...
### <a name="av1014"></a> Avoid exposing the other objects an object depends on (AV1014) ![](/codingguidelines/assets/images/2.png)
...
### <a name="av1020"></a> Avoid bidirectional dependencies (AV1020) ![](/codingguidelines/assets/images/1.png)
