...
### <a name="av1210"></a> Don't swallow errors by catching generic exceptions (AV1210) ![](/assets/images/2.png) ![](/assets/images/A.png)
...
### <a name="av1250"></a> Evaluate the result of a LINQ expression before returning it (AV1250) ![](/assets/images/2.png) ![](/assets/images/A.png)
...
### <a name="crd1206"></a> Strings that are presented to the end users should never be hardcoded (CRD1206) ![](/assets/images/1.png) ![](/assets/images/R.png)
